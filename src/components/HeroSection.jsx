      ...
      <div className="container max-w-4xl mx-auto text-center z-10">
        <div className="space-y-6">
          ...
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight">
            ...
            <span className="text-primary animate-fade-in-delay-3">
              {" "}
              Ayodeji Daniel
            </span>
            <span className="text-gradient ml-2 animate-fade-in-delay-4">
              {" "}
              Obamiyi
            </span>
          </h1>
          ...
          <div className="pt-4 animate-fade-in-delay-5">
